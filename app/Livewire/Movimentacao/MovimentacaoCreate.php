...
class MovimentacaoCreate extends Component
{
    ...
    public function store()
    {
        ...
        if($produto->qtd_estoque < $this->quantidade_movimentada 
        && $this->tipo === 'saida'){
        ...
        if($this->tipo == "entrada"){
            //$produto->qd_estoque = $produto->qd_estoque + $this->quantidade_movimentada;
            //$produto->qd_estoque += $this->quantidade_movimentada;
